...
if ($num > 0) {
    echo "<table class='table table-hover table-light data'><thead class='table-warning'><tr><th scope='col'>FROM</th><th scope='col'>TO</th><th scope='col'>AMOUNT TRANSFERRED</th></tr></thead>";
...
<section id="section2">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <button type="button" class="button mx-3 my-4" onclick="location.href='index.php'">HOME</button>
            </div>
            <div class="col-lg-6">
            <button type="button" class="button1 mx-3 my-4" onclick="location.href='customers.php'">VIEW CUSTOMERS</button>
            </div>
        </div>
    </div>
